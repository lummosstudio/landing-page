      ...
      <div className="mx-auto max-w-[1240px] px-4 sm:px-6 lg:px-8">
            ...
            <li key={project.title}>
              <article className="group h-full flex flex-col justify-between">
                <div className="relative overflow-hidden rounded-2xl bg-card shadow-sm">
                  ...
                  />
                  <span className="absolute right-3 bottom-3 inline-flex size-9 items-center justify-center rounded-full bg-navy/90 text-primary-foreground backdrop-blur shadow-md transition-transform group-hover:scale-110">
        ...
        <div className="mt-9 sm:mt-10 flex justify-center">
          <Button
            asChild
            variant="outline"
            className="h-11 sm:h-12 w-full sm:w-auto rounded-xl border-border bg-card px-6 text-[14px] font-semibold text-navy hover:bg-secondary"
          >
            <a href="#work">
              View All Projects
        ...
        {/* Stats Banner */}
        <div className="mt-10 sm:mt-12 rounded-2xl border border-border bg-card p-6 sm:p-8 lg:p-10 shadow-[0_20px_50px_-36px_var(--navy)]">
          <div className="grid gap-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:divide-x divide-border">
            ...
            {STATS.map(({ icon: Icon, value, label }) => (
              <div key={label} className="flex items-center gap-4 sm:pt-0 lg:px-8">
                <div className="inline-flex size-12 shrink-0 items-center justify-center rounded-xl bg-secondary">
                  <Icon
